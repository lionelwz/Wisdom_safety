...
public class ImageGridAdapter extends BaseAdapter {
    ...
    public ImageGridAdapter(Context context, boolean showCamera, int column, boolean isVideo){
        mContext = context;
        mIsVideo = isVideo;
        mInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        this.showCamera = showCamera;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(isShowCamera()){
            if(i == 0){
                if(mIsVideo) {
                    view = mInflater.inflate(R.layout.mis_layout_video_item, viewGroup, false);
                } else {
    ...
    class ViewHolder {
        ...
        ViewHolder(View view){
            ...
            durationTv = (TextView) view.findViewById(R.id.video_duration);
            view.setTag(this);
        }
        ...
        void bindData(final Image data){
            ...
            if (imageFile.exists()) {
                if(mIsVideo) {
                    ...
                    durationTv.setText(stringForTime(data.duration));
                    // 显示图片
                    Glide.with(mContext)
