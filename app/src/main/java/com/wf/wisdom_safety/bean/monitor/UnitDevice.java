package com.wf.wisdom_safety.bean.monitor;
...
public class UnitDevice implements Serializable {
    ...
    private static final long serialVersionUID = 8633299776744734588L;
    ...
    public String getTempFactory() {
        return tempFactory;
    }

    public void setTempFactory(String tempFactory) {
