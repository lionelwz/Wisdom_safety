...
import com.wf.wisdom_safety.ui.WisdomSafetyApplication;
...
public class SharedPreferenceUtil {
    ...
    public static void save(String fileKey, String key, Object saveObject) {
        SharedPreferences sharedPreferences = WisdomSafetyModule.getContext().getSharedPreferences(fileKey, Activity.MODE_PRIVATE);
